...
title: How to use?
slug: how-arcus
description: Arcus' main goal is to make your application development more efficient. This includes infrastructure or boilerplate code that is almost exactly the same on every project.
order: 1
---
...
<Section>
    <Section.Full marked>
        ...
        Arcus' main goal is to make your application development more efficient.
        This includes infrastructure or boilerplate code that is almost exactly the same on every project.
        You can see Arcus as the middleware between your business application code and Azure components.

        Focusing on application code as much as possible, that's where Arcus comes in.

        ![Code - Arcus - Azure](./assets/code-arcus-azure.png)
        ...
        ![Logger Arcus - Application Insights](./assets/logger-arcus-appinsights.png)
        ...
        ### Why not use the Microsoft package for telemetry?
        ...
        ![Secret - Arcus - Key Vault](./assets/secret-arcus-keyvault.png)
        ...
        ### Why not use the Microsoft package for Azure Key Vault?
        ...
        ![Handler - Arcus - Service Bus](./assets/handler-arcus-servicebus.png)
        ...
        ### Why not use Microsoft package for Azure Service Bus?
